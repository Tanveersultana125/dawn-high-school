...
const PROGRAMS = [
  ...
  { cat: 'STEM', icon: '🔬', title: 'Science & Robotics', grades: 'All Levels', rating: 4.9, tag: 'Innovation Track', desc: 'Hands-on robotics, AI, and engineering in state-of-the-art smart labs.', long: 'On the Innovation Track, students design, build, and code in state-of-the-art smart labs. From robotics and AI to hands-on engineering challenges, learners turn ideas into working prototypes — building the creativity, resilience, and technical fluency the future demands.' },

...
const PROGRAMS = [
  ...
  { cat: 'STEM', icon: '🔬', title: 'Science & Discovery', grades: 'All Levels', rating: 4.9, tag: 'Hands-on STEM', desc: 'Hands-on science experiments and beginner robotics in our school labs.', long: 'In our science and computer labs, students explore practical experiments and beginner robotics kits. Through science-fair projects, simple coding, and STEM club activities, learners build curiosity, teamwork, and problem-solving skills — a solid, practical foundation for the years ahead.' },
  { cat: 'STEM', icon: '💻', title: 'Digital & Coding', grades: 'Grade 3+', rating: 4.8, tag: 'Smart Campus', desc: 'Coding from an early age on a connected, future-ready learning platform.', long: 'Our Smart Campus introduces coding from an early age on a connected, future-ready platform. Students progress from block-based logic to real programming languages, building apps, games, and digital solutions while developing computational thinking that powers every modern career.' },

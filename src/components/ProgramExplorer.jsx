...
const PROGRAMS = [
  ...
  { cat: 'STEM', icon: '💻', title: 'Digital & Logic', grades: 'Grade 3+', rating: 4.8, tag: 'Smart Campus', desc: 'Building logical thinking through pseudo coding and step-by-step problem solving.', long: 'On our Smart Campus, students build computational thinking through pseudo coding — writing simple, step-by-step instructions and flowcharts to solve everyday problems. Starting from block-based logic puzzles, learners develop reasoning, sequencing, and problem-solving skills at an age-appropriate pace.' },

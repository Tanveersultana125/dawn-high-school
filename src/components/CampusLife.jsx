...
const CARDS = [
  ...
  { icon: '🤝', title: 'Student Clubs', stat: '40+ Clubs', desc: '40+ clubs from debate and MUN to coding and entrepreneurship.', img: U('photo-1529070538774-1843cb3265df'), grad: 'linear-gradient(150deg,#103374,#4f86f7)', cls: 'wide' },

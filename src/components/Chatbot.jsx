  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
      >
        <span className="cbot-launch-ic" aria-hidden="true">
          {open ? (
            ...
            <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor">
              <path d="M4 4h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H9l-4.6 3.68A1 1 0 0 1 3 20.9V6a2 2 0 0 1 2-2Zm3 6a1.3 1.3 0 1 0 0 2.6A1.3 1.3 0 0 0 7 10Zm5 0a1.3 1.3 0 1 0 0 2.6A1.3 1.3 0 0 0 12 10Zm5 0a1.3 1.3 0 1 0 0 2.6A1.3 1.3 0 0 0 17 10Z" />
            </svg>
          )}
        </span>
          ...
          >
            <header className="cbot-head">
              <span className="cbot-logo" aria-hidden="true">
                <img src="/dawn-logo-badge.png" alt="" width="46" height="46" />
              </span>

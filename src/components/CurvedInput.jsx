...
/*
 * Curved input bar (React Bits, JS + CSS variant), vendored as-is.
 *
 * The visible field is an SVG whose text rides a circular arc; a transparent
 * native <input> sits on top for real keyboard/IME behaviour, and the caret is
 * drawn manually at the measured arc position.
 */

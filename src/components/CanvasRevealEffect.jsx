...
/**
 * WebGL dot-matrix "reveal" effect (adapted from Aceternity UI to plain JS).
 * Rendered inside CardSpotlight's cursor-masked layer.
 */
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={`canvas-reveal ${containerClassName}`.trim()}>
      ...
      {showGradient && (
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to top, #030712, transparent 84%)',
          }}
        />
      )}
    </div>
...
const Shader = ({ source, uniforms, maxFps = 60 }) => {
  return (
    <Canvas className="canvas-reveal__canvas">

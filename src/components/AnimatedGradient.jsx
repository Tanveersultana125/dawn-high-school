...
// A self-contained WebGL2 animated gradient background.
// Adapted from a shadcn/TSX snippet to plain JSX for this Vite project.
// Renders an absolutely-positioned canvas that fills its (position:relative)
// parent and sits behind the content. Pick a preset or pass a custom config.

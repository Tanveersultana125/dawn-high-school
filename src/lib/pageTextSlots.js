...
const academicsSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      F('academics.excel.topperName', 'Featured topper name', 'Anas Muzaffar'),
      F('academics.excel.bannerTop', 'Banner — top line', 'Congratulations to our students for achieving'),
      F('academics.excel.bannerTitle', 'Banner — big title', 'THE HIGHEST MARKS'),
      F('academics.excel.bannerSub', 'Banner — sub line', 'in the SSC Telangana State Board Examinations — Dawn High School, Hyderabad.', true),
      F('academics.excel.boardTitle', 'Grid heading', 'Achievers of Highest Marks'),
      F('academics.excel.name1', 'Achiever name 1', 'Zubia Muqtadir'),
      F('academics.excel.name2', 'Achiever name 2', 'Juveria Raza'),
      F('academics.excel.name3', 'Achiever name 3', 'Saif Ullah Shareef'),
      F('academics.excel.name4', 'Achiever name 4', 'Md. Mujtaba Hussain'),
      F('academics.excel.name5', 'Achiever name 5', 'Junainah Hajar'),
      F('academics.excel.name6', 'Achiever name 6', 'Hafsa Tahreem'),
      F('academics.excel.name7', 'Achiever name 7', 'Syeda Sayema Maheen'),
      F('academics.excel.name8', 'Achiever name 8', 'Syed Armaan'),
      F('academics.excel.name9', 'Achiever name 9', 'Zunaira Fatima'),
      F('academics.excel.name10', 'Achiever name 10', 'Aisha Khan'),
    ],
  },
  {

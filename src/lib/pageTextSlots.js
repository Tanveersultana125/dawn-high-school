...
const academicsSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      F('academics.excel.name1', 'Achiever name 1', 'Aisha Khan'),
      F('academics.excel.name2', 'Achiever name 2', 'Fatima Noor'),
      F('academics.excel.name3', 'Achiever name 3', 'Mohammed Faiz'),
      F('academics.excel.name4', 'Achiever name 4', 'Sara Ahmed'),
      F('academics.excel.name5', 'Achiever name 5', 'Zaid Ali'),
      F('academics.excel.name6', 'Achiever name 6', 'Ayesha Siddiqui'),
      F('academics.excel.name7', 'Achiever name 7', 'Ibrahim Shaikh'),
      F('academics.excel.name8', 'Achiever name 8', 'Zunaira Fatima'),
    ],
  },
  {

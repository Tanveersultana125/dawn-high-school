...
export const PAGE_IMAGE_GROUPS = [
  ...
  },
  {
    ...
    slots: [
      ...
      { key: 'academics.excel.topper', label: 'Featured topper photo', def: U('photo-1531123897727-8f129e1688ce') },
      { key: 'academics.excel.1', label: 'Achiever photo 1', def: U('photo-1544005313-94ddf0286df2') },
      { key: 'academics.excel.2', label: 'Achiever photo 2', def: U('photo-1494790108377-be9c29b29330') },
      { key: 'academics.excel.3', label: 'Achiever photo 3', def: U('photo-1507003211169-0a1dd7228f2d') },
      { key: 'academics.excel.4', label: 'Achiever photo 4', def: U('photo-1506794778202-cad84cf45f1d') },
      { key: 'academics.excel.5', label: 'Achiever photo 5', def: U('photo-1534528741775-53994a69daeb') },
      { key: 'academics.excel.6', label: 'Achiever photo 6', def: U('photo-1573497019940-1c28c88b4f3e') },
      { key: 'academics.excel.7', label: 'Achiever photo 7', def: U('photo-1544005313-94ddf0286df2') },
      { key: 'academics.excel.8', label: 'Achiever photo 8', def: U('photo-1500648767791-00dcc994a43e') },
      { key: 'academics.excel.9', label: 'Achiever photo 9', def: U('photo-1531123897727-8f129e1688ce') },
      { key: 'academics.excel.10', label: 'Achiever photo 10', def: U('photo-1519085360753-af0119f7cbe7') },
    ],
  },
  {
    page: 'Campus',
